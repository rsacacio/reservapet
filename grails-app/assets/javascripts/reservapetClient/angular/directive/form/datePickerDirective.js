(function () {
    ...
    angular.module('reservapetApp').directive('reservapetDatePicker', reservapetDatePicker);

    reservapetDatePicker.$inject = ['LocaleDateFactory'];
    function reservapetDatePicker(LocaleDateFactory) {
        ...
        return {
            link: component,
            replace: false,
            templateUrl: 'assets/reservapetClient/partials/directive/form/dateRangeDirective.html',
            scope: {
                min: '=',
                single: '=',
                ngModel: '=',
